...
import mbaDigital from '../../assets/images/Administration-with-specialization-in-Digital-Business.jpg';
    ...
    >
      ...
      <NavbarContent className="hidden sm:flex gap-6" justify="center">
        ...
        <Dropdown
          showArrow
          classNames={{
            base: 'bg-white w-full mt-1 rounded-b-xl',
          }}
        >
          <DropdownTrigger>
            <Button className="text-[#10407c] text-sm font-montserrat font-semibold">
              Programs
              <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" viewBox="0 0 24 24"><path fill="#10407c" d="M12 14.975q-.2 0-.375-.062T11.3 14.7l-4.6-4.6q-.275-.275-.275-.7t.275-.7t.7-.275t.7.275l3.9 3.9l3.9-3.9q.275-.275.7-.275t.7.275t.275.7t-.275.7l-4.6 4.6q-.15.15-.325.213t-.375.062"/></svg>
            </Button>
          </DropdownTrigger>
          ...
          >
            <DropdownSection
              ...
              classNames={{
                base: 'w-[450px]',
                heading:
                  'text-[#10407c] text-md font-montserrat font-semibold p-2 text-start break-normal',
              }}
            >
              <DropdownItem
                key="computerscience1"
                href={`/${locale}/programs/undergraduate-programs/computer-science/bachelor-computer-science`}
              >
                <div className="flex flex-row justify-between items-center p-2 w-full">
                  <div
                    className="text-[#10407c] text-sm font-montserrat font-regular pr-2 text-start break-normal"
                    style={{ whiteSpace: 'pre-wrap' }}
                  >
                    Affordable Bachelor of Science in Computer Science
                  </div>
                  <svg
              ...
              <DropdownItem
                key="computerscience2"
                href={`/${locale}/programs/undergraduate-programs/computer-science/associate-artificial-inteligence`}
              >
                <div className="flex flex-row justify-start items-center p-2 w-full">
                  <div
                    className="text-[#10407c] text-sm font-montserrat font-regular pr-2 text-start break-normal"
                    style={{ whiteSpace: 'pre-wrap' }}
                  >
                    Affordable Associate of Science in Computer Science with
              ...
              <DropdownItem
                key="computerscience3"
                href={`/${locale}/programs/undergraduate-programs/computer-science/associate-cloud-computing`}
              >
                <div className="flex flex-row justify-start items-center p-2 w-full">
                  <div
                    className="text-[#10407c] text-sm font-montserrat font-regular pr-2 text-start break-normal"
              ...
              <DropdownItem
                key="computerscience4"
                href={`/${locale}/programs/undergraduate-programs/computer-science/associate-cybersecurity`}
              >
                <div className="flex flex-row justify-start items-center p-2 w-full">
                  <div
                    className="text-[#10407c] text-sm font-montserrat font-regular pr-2 text-start break-normal"
              ...
              <DropdownItem
                key="computerscience5"
                href={`/${locale}/programs/graduate-programs/computer-science/master-artificial-inteligence`}
              >
                <div className="flex flex-row justify-start items-center p-2 w-full">
                  <div
                    className="text-[#10407c] text-sm font-montserrat font-regular pr-2 text-start break-normal"
                    style={{ whiteSpace: 'pre-wrap' }}
                  >
                    Affordable Master of Science in Computer Science with
                    Specialization in Artificial Intelligence
                  </div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <DropdownItem
                key="computerscience6"
                href={`/${locale}/programs/graduate-programs/computer-science/master-cloud-computing`}
              >
                <div className="flex flex-row justify-start items-center p-2 w-full">
                  <div
                    className="text-[#10407c] text-sm font-montserrat font-regular pr-2 text-start break-normal"
              ...
              <DropdownItem
                key="computerscience7"
                href={`/${locale}/programs/graduate-programs/computer-science/master-cybersecurity`}
              >
                <div className="flex flex-row justify-start items-center p-2 w-full">
                  <div
                    className="text-[#10407c] text-sm font-montserrat font-regular pr-2 text-start break-normal"
            ...
            >
              <DropdownItem
                key="business1"
                href={`/${locale}/programs/undergraduate-programs/digital-business/bachelor-digital-business`}
              >
                <div className="flex flex-row justify-start items-center p-2 w-full">
                  <div
                    className="text-[#10407c] text-sm font-montserrat font-regular pr-2 text-start break-normal"
                    style={{ whiteSpace: 'pre-wrap' }}
                  >
                    Affordable Bachelor of Science in Digital Business
                  </div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="22px"
              ...
              <DropdownItem
                key="business2"
                href={`/${locale}/programs/undergraduate-programs/digital-business/associate-digital-business`}
              >
                <div className="flex flex-row justify-start items-center p-2 w-full">
                  <div
                    className="text-[#10407c] text-sm font-montserrat font-regular pr-2 text-start break-normal"
                    style={{ whiteSpace: 'pre-wrap' }}
                  >
                    Affordable Associate of Science in Digital Business
                  </div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="22px"
              ...
              <DropdownItem
                key="business3"
                href={`/${locale}/programs/graduate-programs/business-administration/mba-digital-business`}
              >
                <div className="flex flex-row justify-start items-center p-2 w-full">
                  <div
                    className="text-[#10407c] text-sm font-montserrat font-regular pr-2 text-start break-normal"
                    style={{ whiteSpace: 'pre-wrap' }}
                  >
                    Affordable MBA with Specialization in Digital Business
                  </div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="22px"
              ...
              <DropdownItem
                key="business4"
                href={`/${locale}/programs/graduate-programs/business-administration/mba-sustainability`}
              >
                <div className="flex flex-row justify-start items-center p-2 w-full">
                  <div
                    className="text-[#10407c] text-sm font-montserrat font-regular pr-2 text-start break-normal"
                    style={{ whiteSpace: 'pre-wrap' }}
                  >
                    Affordable MBA with Specialization in Sustainability
                  </div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="22px"
            ...
            >
              <DropdownItem
                key="education1"
                href={`/${locale}/programs/graduate-programs/education/master-digital-education`}
              >
                <div className="flex flex-row justify-start items-center p-2 w-full">
                  <div
                    className="text-[#10407c] text-sm font-montserrat font-regular pr-2 text-start break-normal"
                    style={{ whiteSpace: 'pre-wrap' }}
                  >
                    Affordable Master of Science in Education with
                    Specialization in Digital Education
                  </div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="32px"
              ...
              <DropdownItem
                key="education2"
                href={`/${locale}/programs/graduate-programs/education/master-sustainability`}
              >
                <div className="flex flex-row justify-start items-center p-2 w-full">
                  <div
                    className="text-[#10407c] text-sm font-montserrat font-regular pr-2 text-start break-normal"
