    ...
    <div className="overflow-hidden">
      ...
      >
        ...
        <div className={'w-10/12 md:w-11/12 sm:w-full sm:h-[280px] rounded-2xl absolute bottom-[-40px] md:bottom-[-140px] lg:bottom-[-40px] z-20 max-w-screen-2xl grid grid-cols-1 sm:grid-cols-4 gap-4'}>
          ...
          <div className={'bg-white h-[280px] sm:h-full rounded-2xl p-10 shadow-2xl justify-between items-start flex flex-col overflow-hidden transition-all duration-300 hover:sm:-translate-y-4'}>
            <div>
            <svg xmlns="http://www.w3.org/2000/svg" width="3em" height="3em" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M20.779 10.007a9 9 0 1 0-10.77 10.772M13 21h8v-7"/><path d="M12 8v4l3 3"/></g></svg> <div className={'text-xl text-start text-[#192335] font-euclid font-bold mt-4'}>
                Free 7 Days Trial
              </div>
            </div>
            <div className={'text-sm text-start text-[#192335] font-montserrat font-regular'}>
              Experience our free 7-day trial with no obligations, credit card information, or hidden catches. 
            </div>
          </div>
        </div>
